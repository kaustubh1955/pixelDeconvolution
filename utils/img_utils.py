...
#cropping the center of the image for getting 256x256 size
...
def transform(image, pre_height, pre_width, height, width, is_crop):
    ...
    return np.array(new_image)/127.5 - 1.  #normalizing images b/w -1,1
...
#generating and saving segmented images
